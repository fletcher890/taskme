...
(function() {
  ...
  define(["jquery", "underscore", "backbone", "vent", "validatable", "text!templates/tasks/new_task.html", "handlebars"], function($, _, Backbone, Vent, Validatable, newTaskTemplate, Handlebars) {
  var newTaskView;
