...
(function() {
  define(["jquery", "underscore", "backbone", "vent", "validatable", "text!templates/tasks/new_task.hbs", "handlebars"], function($, _, Backbone, Vent, Validatable, newTaskTemplate, Handlebars) {
    var newTaskView;
