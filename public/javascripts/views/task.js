...
(function() {
  define(["jquery", "underscore", "backbone", "vent", "views/comment", "collections/tasks", "text!templates/tasks/task.haml", "handlebars"], function($, _, Backbone, Vent, CommentView, taskCollection, taskTemplate, Handlebars) {
    var task;
