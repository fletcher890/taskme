...
(function() {
  define(["jquery", "jqueryui", "jqueryuipunch", "underscore", "backbone", "vent", "views/task", "collections/tasks", "text!templates/tasks/tasks.hbs", "text!templates/partials/filter_dropdown.hbs", "handlebars"], function($, $ui, $punch, _, Backbone, Vent, TaskView, TasksCollection, tasksTemplate, filterTemplate, Handlebars) {
    var tasks;
